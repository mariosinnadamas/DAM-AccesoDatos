    ...
    public static void main(String[] args) {
        ...
        try(Connection con = DriverManager.getConnection(URL,USERNAME,PASS)){
            try (Statement sentencia = con.createStatement()){
                String consulta = "SELECT * FROM empleados.empleados e JOIN empleados.departamentos d ON e.id_departamento = d.id_departamento WHERE d.nombre_departamento = 'Ventas'";
